...
<body class="">
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper scrollspy-container">
			...
			<div class="page-title detail-page-title" style="background-image:url('${ticket.headerPicture}');">
				...
				<div class="container">
					...
					<div class="flex-row">
						...
						<div class="flex-column flex-md-8 flex-sm-12">
							...
							<h1 class="hero-title">${ticket.name }</h1>
							
							<ul class="list-col clearfix">
								<li class="price-box">
									<div class="meta">
										<span class="block"><span style="color: red;">等级:</span>${ticket.level }</span>
									</div>
								</li>
								...
								<li class="price-box">
									<div class="meta">
										<span class="block"><span style="color: red;">地址：</span>${ticket.address }</span>									
									</div>
								</li>
								...
								<li class="price-box">
									<div class="meta">
										<span class="block"><span style="color: red;">开放时间：</span>${ticket.openDate }</span>			
									</div>
								</li>
								...
								<li class="price-box">
									<div class="meta">
										<span class="block"><span style="color: red;">价格：</span>￥${ticket.price }起</span>		
									</div>
								</li>
						...
						<div class="flex-column flex-md-4 flex-align-bottom flex-sm-12 mt-20-sm">
							<div class="text-right text-left-sm">
								<a href="<%=request.getContextPath()%>/ticket/pay/${ticket.id}" class="anchor btn btn-primary">马上预订</a>
							</div>
						</div>
									...
									<div id="section-1" class="detail-content">
										...
										<div class="slick-gallery-slideshow">
											...
											<div class="slider gallery-slideshow">
												<c:forEach items="${fn:split(ticket.picture,';') }" var="picture">
								...
								<ul class="scrollspy-sidenav">
									...
									<li>
										<ul class="nav">
											...
											<li><a href="#section-2" class="anchor">交通路线</a></li>
											<li><a href="#section-3" class="anchor">预订须知</a></li>
										</ul>
									</li>
